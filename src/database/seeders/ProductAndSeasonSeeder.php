...
class ProductAndSeasonSeeder extends Seeder {
    public function run() {
        // 季節データの作成
        $seasons = [
            '春' => Season::create( [ 'name' => '春' ] ),
            '夏' => Season::create( [ 'name' => '夏' ] ),
            '秋' => Season::create( [ 'name' => '秋' ] ),
            '冬' => Season::create( [ 'name' => '冬' ] ),
        ];
        ...
        foreach ( $products as $productData ) {
            $product = Product::create( [
                ...
                'img' => Storage::url( $productData[ 'img' ] ), // storageのURLで取得
            ] );

            // 関連する季節をアタッチ
            foreach ( $productData[ 'seasons' ] as $season ) {
                $product->seasons()->attach( $seasons[ $season ]->id );
            }
        }
    }
}
